...
namespace BullsAndCowsTest
{
    public class BullsAndCowsGameTest
    {
        ...
        [Theory]
        [InlineData("4321")]
        public void Should_return_0A4B_when_Guess_given_correct_digits_wrong_loc(string guessNumber)
        {
            // Given
            string secret = "1234";
        ...
        [InlineData("3546")]
        [InlineData("3561")]
        public void Should_return_0A2B_when_Guess_given_partial_correct_digits_wrong_loc(string guessNumber)
        {
            // Given
            string secret = "1234";
        ...
        [InlineData("2134")]
        [InlineData("1243")]
        public void Should_return_2A2B_when_Guess_given_partial_correct_digits_partial_correct_loc(string guessNumber)
        {
            // Given
            string secret = "1234";
